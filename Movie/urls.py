...
from .views import login_view, signup, logout_view,index,detail,search,review_rate,add_to_liked_list,add_to_playlist, recommend_similar_series,view_playlists
